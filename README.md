[スマートマップ焼津](https://maps.yaizu-smartcity.jp/)、および焼津焼津都市情報APIを使うと、営利・非営利を問わず、地図と位置情報を活用したウェブサイトやアプリケーションを作ることができます。
...
## 「スマートマップ焼津」と「焼津焼津都市情報API」 について

「スマートマップ焼津」と「焼津焼津都市情報API」 は、焼津市が公開するサービスです。
